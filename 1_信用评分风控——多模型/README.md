...
- **住房**：租房50.5%，抵押贷款41.3%
- **贷款用途**：教育贷款19.8%，医疗贷款18.6%，创业贷款17.6%

| 年龄分布 | 收入分布 | 各年龄段收入分布 | 贷款用途分布 |
|---------|---------|----------------|-------------|
| ![年龄分布](./chats/age_distribution.png) | ![收入分布](./chats/income_distribution.png) | ![各年龄段收入分布](./chats/age_income_distribution.png) | ![贷款用途分布](./chats/loan_intent_distribution.png) |
